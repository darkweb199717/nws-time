...
import Adsterra468 from '@/components/Adsterra468'
    ...
    <div className="w-full bg-background">
      ...
      <div id="calculators" className="px-4 py-16 md:py-24">
        <div className="max-w-7xl mx-auto">
          ...
          {/* Main calculator + desktop sidebar */}
          <div className="flex flex-col xl:flex-row gap-8 items-start">
            ...
            {/* Desktop Sidebar Ads */}
            <aside className="hidden xl:flex w-[160px] shrink-0 flex-col items-center gap-8">
